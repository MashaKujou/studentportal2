  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      messagingService.createNotification({
        ...
        message: `Your ${typeLabel[selected.type]} request has been approved.${adminResponse.trim() ? ` Admin note: ${adminResponse.trim()}` : ""
          }`,
                ...
                {filtered.map((req) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-3 border rounded-lg transition-colors ${selectedId === req.id
                  ...
                  <div className="space-y-3 pt-2 border-t">
                    <div>
                      <label className="block text-sm font-medium mb-1">
                        Response Note <span className="text-muted-foreground font-normal">(required for rejection)</span>
                      </label>
                      <Textarea
                        placeholder={
                          selected.type === "leave_of_absence"
